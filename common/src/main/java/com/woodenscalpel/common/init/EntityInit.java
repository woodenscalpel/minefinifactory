...
public class EntityInit {
    ...
    public static final RegistrySupplier<EntityType<BaseEntity>> baseEntityType = ENTITIES.register(new ResourceLocation(MOD_ID+"baseentity"), () -> EntityType.Builder.<BaseEntity>of(BaseEntity::new, MobCategory.MISC).sized(1f,1f).build(new ResourceLocation(MOD_ID, "baseentity").toString()));
